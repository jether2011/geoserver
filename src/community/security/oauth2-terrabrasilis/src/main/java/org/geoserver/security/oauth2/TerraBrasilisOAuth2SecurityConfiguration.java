 ...
 */
@Configuration(value = "TerraBrasilisOAuth2SecurityConfiguration")
@EnableOAuth2Client
class TerraBrasilisOAuth2SecurityConfiguration extends GeoServerOAuth2SecurityConfiguration {

    @Bean(name = "TerraBrasilisOAuth2Resource")
    ...
    protected String getDetailsId() {
        return "terrabrasilis-oauth2-client";
    }

    /** Must have "session" scope */
    @Bean(name = "TerraBrasilisOauth2RestTemplate")
